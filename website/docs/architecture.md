...
The design is documented in depth in the whitepaper (in the repository):

1. [Backend architecture](https://github.com/ProjectBay/openbucket/blob/main/docs/whitepaper/01-backend-architecture.md)
2. [S3 protocol & SigV4](https://github.com/ProjectBay/openbucket/blob/main/docs/whitepaper/02-s3-protocol-and-sigv4.md)
3. [Persistence & storage](https://github.com/ProjectBay/openbucket/blob/main/docs/whitepaper/03-persistence-and-storage.md)
4. [Streaming & concurrency](https://github.com/ProjectBay/openbucket/blob/main/docs/whitepaper/04-streaming-and-concurrency.md)
5. [Admin frontend, auth & delivery](https://github.com/ProjectBay/openbucket/blob/main/docs/whitepaper/05-admin-frontend-auth-delivery.md)
...
[`CONTRIBUTING.md`](https://github.com/ProjectBay/openbucket/blob/main/CONTRIBUTING.md)
and the [Code of Conduct](https://github.com/ProjectBay/openbucket/blob/main/CODE_OF_CONDUCT.md).
